...
class CreateCoinStore {
  handleCreateCoins(btcWallet_privateKey, btcWalletAddress, ethWallet_privateKey, ethWalletAddress){    
    let btcCoin = new Coin({
      ...
      token_contract_address:'', decimals:0, balance:0, isAdded: true
    })
    let ethCoin = new Coin({
      ...
      token_contract_address:'', decimals:18, balance:0, isAdded: true
    })
    let daiCoin = new Coin({
      ...
      token_contract_address:'0x123456789012345678', decimals:6, balance:0, isAdded: true
    })
    let usdcCoin = new Coin({
      token_name:'USD Stable', token_symbol: 'USDC', wallet_symbol:'ETH', wallet_privatekey:ethWallet_privateKey, wallet_address: ethWalletAddress,
      token_contract_address:'0x234567890123456789', decimals:6, balance:0, isAdded: true
    })

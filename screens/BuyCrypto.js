        ...
        <ScrollView style={ styles.ScrollViewContainer}>    
          ...
          <ImageBackground source={require('../assets/images/WalletBackground.png')} style={styles.WalletBackground}>
            <Col style={ styles.WalletCol}>
                ...
                <TouchableOpacity style={styles.WalletButton} onPress={this._onPressButton}><Text style={styles.WalletButtonText}>CHANGE</Text></TouchableOpacity>
            </Col>
          </ImageBackground>
          </Grid>
...
WalletButtonText:{ fontSize:14, lineHeight:Platform.OS === 'ios' ? 30 : 35, textAlign:"center", color:"#fff"   },
...
BackupButton:{ textAlign:"center", lineHeight:Platform.OS === 'ios' ? 40 : 50, color:"#f5f5f5", fontSize:16},

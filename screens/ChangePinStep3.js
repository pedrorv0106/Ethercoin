...
export default class ChangePinThreeComponent extends Component{
    ...
    constructor(props) {
        super(props);
        this.state = {
            prePinValue: props.navigation.state.params.pinValue,
            pinValue:''
        };
    }
    ...
    checkPincode(pinValue){
        const {prePinValue} = this.state
        if(prePinValue === pinValue){
            MainStore.appState.setPinCode(pinValue)
            Alert.alert(
                'Success',
                'PIN is changed.',
                [
            ...
            Alert.alert(
                'Error',
                'Please input correct PIN again.',
                [
        ...
        return (
            <View style={ styles.container }>
                <ImageBackground source={require('../assets/images/inner-header-bg.jpg')} style={styles.backgroundImage}>      
                    ...
                    <Text style={ styles.PageTitle}>Confirm Your PIN</Text> 
                    <TouchableOpacity>
                    </TouchableOpacity>             
                </ImageBackground>

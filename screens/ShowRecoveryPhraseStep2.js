          ...
          <View style={ styles.PhraseContainer}>
            ...
            <View style={ styles.PhraseCol}>
              <View style={ styles.PhraseColList}>
                  ...
                  <Text style={ styles.PhraseColText}>accuse</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>2</Text>
                  <Text style={ styles.PhraseColText}>leader</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>3</Text>
                  <Text style={ styles.PhraseColText}>thumb</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>4</Text>
                  <Text style={ styles.PhraseColText}>section</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>5</Text>
                  <Text style={ styles.PhraseColText}>define</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>6</Text>
                  <Text style={ styles.PhraseColText}>honest</Text>
              </View>
            ...
            <View style={ styles.PhraseColList}>
                  ...
                  <Text style={ styles.PhraseColText}>silent</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>8</Text>
                  <Text style={ styles.PhraseColText}>temper</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>9</Text>
                  <Text style={ styles.PhraseColText}>atom</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>10</Text>
                  <Text style={ styles.PhraseColText}>height</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>11</Text>
                  <Text style={ styles.PhraseColText}>wish</Text>
              </View>

              <View style={ styles.PhraseColList}>
                  <Text style={ styles.PhraseColNumber}>12</Text>
                  <Text style={ styles.PhraseColText}>test</Text>
              </View>
...
PageTitle:{ textAlign:"center", lineHeight:90, color:"#fff", fontSize:20 },

...
const styles = StyleSheet.create({
  ...
  PassphraseListNumber:{ fontFamily:"LatoRegular", fontWeight:"bold", position:"absolute", left:10, top:10, width:40, height:40, borderRadius:20, borderColor:"#6137a7", borderWidth:2, textAlign:"center", lineHeight:Platform.OS === 'ios' ? 28 : 40, borderStyle:"solid", color:"#6137a7", fontSize:20, },
